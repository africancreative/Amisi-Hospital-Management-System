...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
    ...
    NURSE: ['TRIAGE_WRITE', 'WARD_TRACK_WRITE', 'CONSULTATION_WRITE'],
    PHARMACIST: ['PHARM_DISPENSE', 'INV_AUDIT'],
    LAB_TECH: ['LIS_RESULT_WRITE'],
    ACCOUNTANT: ['LEDGER_VIEW', 'BILLING_ADJUST', 'PAYROLL_PROCESS'],
    HR: ['PAYROLL_PROCESS'],
    HR_MANAGER: ['PAYROLL_PROCESS'],
    ADMIN: Object.keys(PERMISSIONS) as Permission[],
    MIDWIFE: ['CONSULTATION_WRITE', 'WARD_TRACK_WRITE'],
    ICU_NURSE: ['CONSULTATION_WRITE', 'WARD_TRACK_WRITE'],
    ONCOLOGY_NURSE: ['CONSULTATION_WRITE', 'WARD_TRACK_WRITE'],
    RADIOGRAPHER: ['RIS_REPORT_WRITE'],
    RADIOLOGIST: ['RIS_REPORT_WRITE'],
    RECEPTIONIST: ['TRIAGE_WRITE'],
    SECURITY: [],
    CLEANER: [],
    DRIVER: [],
    PATHOLOGIST: ['LIS_RESULT_WRITE'],
    PROCUREMENT_MANAGER: ['PROCUREMENT_WRITE', 'INV_AUDIT'],
    INVENTORY_CLERK: ['INV_AUDIT'],
    ADMISSIONS: ['WARD_TRACK_WRITE'],
    NURSE_MANAGER: ['WARD_TRACK_WRITE', 'TRIAGE_WRITE'],
    HIM_OFFICER: ['RECORDS_WRITE'],
    AUDITOR: ['LEDGER_VIEW'],
    SURGEON: ['SURGERY_SCHEDULE', 'CONSULTATION_WRITE'],
