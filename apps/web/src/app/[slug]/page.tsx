...
import { getTenantDashboardStats } from "../actions/dashboard-actions";
        ...
        <header className="flex justify-between items-center mb-10">
          <div>
            ...
            <p className="text-neutral-500 mt-2 text-lg">
              Daily operations and clinical statistics for <span className="text-amber-500 font-bold uppercase tracking-wider">{slug.replace('-', ' ')}</span>.
            </p>
          </div>
