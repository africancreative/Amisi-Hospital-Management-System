        ...
        <div className="flex-1 overflow-y-auto p-8 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white font-sans">
            <div className="mx-auto max-w-7xl">
                ...
                <div className="flex gap-4 mb-10 overflow-x-auto pb-2">
                    <Link href={`/${slug}/billing/invoice/new`} className="inline-flex items-center gap-2 rounded-2xl bg-emerald-500 px-6 py-4 font-black text-white shadow-xl shadow-emerald-500/20 hover:bg-emerald-600 transition-all whitespace-nowrap">
                                        ...
                                        {stats.recentInvoices.map((inv: any) => (
                                            <tr key={inv.id} className="hover:bg-gray-50 dark:hover:bg-gray-900/40 transition-colors">
                                                ...
                                                <td className="px-8 py-4 text-right flex items-center justify-end gap-3">
                                                    <Link href={`/${slug}/billing/${inv.id}`} className="text-xs font-black text-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 px-3 py-2 rounded-lg transition-all">
                                                        Manage
                                                    </Link>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="bg-emerald-600 rounded-3xl p-8 text-white shadow-2xl shadow-emerald-600/30">
                            ...
                            <div className="space-y-4">
                                <ExportInvoiceButton
                                    invoice={{ id: 'GENERAL_LEDGER', totalAmount: stats.totalReceived, status: 'Audited', createdAt: new Date() } as any}
