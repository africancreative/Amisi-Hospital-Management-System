        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
            <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-8">
                    Your hospital account was created successfully but has not been activated yet.
                    Activation and your subscription are approved manually by the Amisi Cloud system
                    administrator. You will be able to sign in once your account is activated.
                </p>

                <div className="space-y-4">
                    <Link
                        href="mailto:support@amisi.com"
                        className="block w-full py-3 px-4 bg-amber-600 hover:bg-amber-700 text-white font-semibold rounded-lg transition-colors"
                    >
                        Contact Support
                    </Link>
